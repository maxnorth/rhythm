...
Rhythm is a Durable Execution framework that makes writing Workflows-as-Code intuitive and effortless. It’s easy to setup and use, requiring only Postgres and package installation. It supports multiple programming languages, each using the shared core engine written in rust.
