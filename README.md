...
- You have seen how the replay-based durable execution can be a risk to maintainability and reliability
- You want a free and easy to run option that isn't influenced by the interests of VC-backed startups
- You don't want to monitor and maintain separate platforms for durable execution *and* background tasks
