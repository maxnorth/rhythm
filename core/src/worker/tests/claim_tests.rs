...
// TODO: Add test_stale_continuation_for_failed_workflow_is_skipped
// Currently blocked by a bug where workflow throws don't commit the Failed status
// because run_workflow returns Err before tx.commit() is called, causing rollback.
