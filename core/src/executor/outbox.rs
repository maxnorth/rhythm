...
/// A task/workflow creation side effect
///
/// Represents a request to create a new task or workflow. This is added to the outbox
/// when Task.run() or Workflow.run() is called, and the external orchestrator will
/// batch-create these executions.
